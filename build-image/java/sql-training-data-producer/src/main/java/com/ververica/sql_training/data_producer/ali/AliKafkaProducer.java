 ...
 */
public class AliKafkaProducer implements Consumer<AliRecord> {

    private final String topic;
    private final org.apache.kafka.clients.producer.KafkaProducer<byte[], byte[]> producer;
    private final JsonSerializer<AliRecord> serializer;

    public AliKafkaProducer(String kafkaTopic, String kafkaBrokers) {
